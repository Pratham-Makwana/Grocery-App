...
const Sidebar: FC<SlidebarProps> = ({
  categories,
  onCategoryPress,
  selectedCategory,
}) => {
      ...
      <ScrollView
        ...
        <View>
          {categories?.map((category: any, index: number) => {
            // console.log(animatedValues[index].value);
            ...
            return (
              <TouchableOpacity
                ...
                <View
                  ...
                  <CustomeText fontSize={RFValue(7)} style={{textAlign : 'center'}} >{category?.name}</CustomeText>
              </TouchableOpacity>
            );
          })}
        </View>
